...
const Request_1 = __nccwpck_require__(7607);
class Webhook {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __nccwpck_require__(4351);
tslib_1.__exportStar(__nccwpck_require__(9753), exports);
tslib_1.__exportStar(__nccwpck_require__(8662), exports);
...
const inputs_1 = __nccwpck_require__(8927);
const release_1 = __nccwpck_require__(6286);
const repo_1 = __nccwpck_require__(3045);
const store_1 = __nccwpck_require__(7575);
...
async function uploadFiles(api, inputs, release, repoData) {
...
async function uploadProvidedFiles(api, inputs, release, repoData) {
...
async function uploadReleaseData(api, inputs, release, repoData, uploads) {
...
const discord_webhook_1 = __nccwpck_require__(9888);
async function sendWebhook(inputs, api, repoData, releaseResponse) {
...
const path_1 = __importDefault(__nccwpck_require__(1017));
const markdown_escape_1 = __importDefault(__nccwpck_require__(5913));
...
async function getDiscussionCategory(_api, _owner, _repo) {
