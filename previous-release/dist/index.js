...
const repo_1 = __nccwpck_require__(78);
async function getLivePrevReleaseData() {
    const baseRepoData = (0, repo_1.getRepoData)(core.getInput('branch'));
...
const auth_app_1 = __nccwpck_require__(946);
const core_1 = __nccwpck_require__(196);
const plugin_rest_endpoint_methods_1 = __nccwpck_require__(840);
const request_1 = __nccwpck_require__(392);
...
const parse = __importStar(__nccwpck_require__(17));
...
var dist = __nccwpck_require__(572);
